...
func RenderMarkdown(device bitmap.Device, bytes []byte, proportionalFamily, monospaceFamily *font.Family, headingStyles []BlockStyle, paragraphStyle BlockStyle) error {
